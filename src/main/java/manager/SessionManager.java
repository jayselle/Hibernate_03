...
public abstract class SessionManager {
    ...
    private static Properties getHibernateProperties() {
        ...
        props.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/hibernateherenciasubclase");
    ...
    private static void registerMappers(Configuration config) throws MappingException {
        ...
        config.addAnnotatedClass(Regular.class);
        config.addAnnotatedClass(Contratado.class);
    }
